...
offset = [-1.0,0.0, 1.0]  # Offset of initial non-interacting wavefunction
...
nsamples = 4000  # Number of samples used to represent the wavefunction
...
perm_subset = 6  # Number of permutations to be considered at every iteration step; maximum value is n_particles!
